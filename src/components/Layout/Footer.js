...
import { noticeList } from "./AcceptText";
import logo from "../../image/HeaderLogo.svg";
import kakaoQR from "../../image/KakaoTalkQR.png";
        ...
        <footer className="F-wrapper">
            ...
            <div className="F-content">
                ...
                <span className="F-company_info_text">
                    <div className="F-name">(주)로또랜드</div>
                    ...
                    <div className="F-copyright">COPYRIGHT ⓒ LOTTOLAND ALL RIGHTS RESERVED</div>
                </span>
                    ...
                    (주)로또랜드는 소비자 보호를 위한 고객센터를 운영하고 있으며,<br />
